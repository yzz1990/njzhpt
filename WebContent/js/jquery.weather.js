	...
	Weather.prototype = {
		...
		init : function(config){
			...
			var weatherInfo = this.opts.weatherData || {},
				...
				/*templeteHtml = '<div> <div class="weather-curshow" style="margin-top:60px;margin-left:-25px;float: left;font-family:微软雅黑;font-size: 58px;color:#ffffff;">{#day_temp#}{#temp#}</div>  <div class="weather-show" <!--style="margin-top:37px;margin-left:70px"--> >  <div class="day_weather" style="font-family:微软雅黑;font-size: 12px;color:#ffffff;margin-top:150px;margin-left:70px"><span class="weather">{#day_weather#}</span></div>  ' +
				'<div style="font-family:微软雅黑;font-size: 20px;color:#ffffff;"><span class="temp">{#day_temp#}{#temp#}</span>~<span>{#night_temp#}{#temp#}</span></div></div> <div class="time" style="font-family: Arial;font-size: 10px;color: #ffffff;margin-top:100px;margin-left:60px;width: 200px;"><span>{#date#}</span></div>'*/
				/*templeteHtml = '<div class="weather-curshow" style="margin-top:60px;margin-left:-25px;float: left;font-family:微软雅黑;font-size: 58px;color:#ffffff;">{#day_temp#}{#temp#}</div>   <div class="day_weather" style="font-family:微软雅黑;font-size: 12px;color:#ffffff;margin-top:0px;margin-left:70px"><span class="weather" >{#day_weather#}</span></div>  ' +
					'<div style="font-family:微软雅黑;font-size: 20px;color:#ffffff;margin-top:80px;margin-left: 70px"><span class="temp">{#day_temp#}{#temp#}</span>~<span>{#night_temp#}{#temp#}</span></div> <div class="time" style="font-family: Arial;font-size: 10px;color: #ffffff;margin-top:40px;margin-left:45px;width: 200px;"><span>{#date#}</span></div>'*/
				templeteHtml = '<div class="weather-curshow" style="margin-top:60px;margin-left:-25px;float: left;font-family:微软雅黑;font-size: 58px;color:#ffffff;">{#day_temp#}{#temp#}</div>   <div class="day_weather" style="font-family:微软雅黑;font-size: 12px;color:#ffffff;margin-top:0px;margin-left:70px">{#day_weather#}</div> ' +
					'<div style="font-family:微软雅黑;font-size: 20px;color:#ffffff;margin-top:80px;margin-left: 70px"><span class="temp">{#day_temp#}{#temp#}</span>~<span>{#night_temp#}{#temp#}</span></div> <div class="time" style="font-family: Arial;font-size: 10px;color: #ffffff;margin-top:30px;margin-left:35px;width: 200px;"><span>{#date#}</span></div> <div class="city" style="font-family: Arial;font-size: 10px;color: #ffffff;margin-left:55px;margin-top:10px">{#city#}</div>'
			i = skyState_child_length-1;
